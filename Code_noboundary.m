% Heat Project Code, Draft 6 -- Timothy Nickell -- SID#20469248 -- 12/02/13
...
Numit=12001; % 10000 = 25 sec; add 1 at end to print last guy
Numpics=300;
...
for k=1:Numit
    ...
    for i=2:nn
        for j=2:nn
            ...
            y=(j-y0);
            r=sqrt(x^2+y^2);
            if r <= N-nn/sw/2 %nn/sw should always give 10; /2 = 5.
